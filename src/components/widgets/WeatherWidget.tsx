            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">{weather.location}</span>
                </div>
                <div className="flex items-center gap-1">
                  <button
                    ...
                    title="View forecast"
                  >
                    <FlipHorizontal className="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" />
                  </button>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
              ...
              {/* Details Grid - Responsive for mobile */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2">
                {weather.feelsLike !== undefined && (
                  <div className="flex flex-col items-center bg-orange-50 dark:bg-orange-900/20 rounded-lg p-1.5 sm:p-2 border border-orange-200 dark:border-orange-800/30">
                    <Thermometer className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-orange-600 dark:text-orange-400 mb-0.5" />
                    <div className="text-[8px] sm:text-[9px] font-semibold text-orange-700 dark:text-orange-300 uppercase mb-0.5">Feels</div>
                    <div className="text-[10px] sm:text-xs font-bold text-orange-900 dark:text-orange-100">{weather.feelsLike}°</div>
                  </div>
                )}
                <div className="flex flex-col items-center bg-blue-50 dark:bg-blue-900/20 rounded-lg p-1.5 sm:p-2 border border-blue-200 dark:border-blue-800/30">
                  <Wind className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-600 dark:text-blue-400 mb-0.5" />
                  <div className="text-[8px] sm:text-[9px] font-semibold text-blue-700 dark:text-blue-300 uppercase mb-0.5">Wind</div>
                  <div className="text-[10px] sm:text-xs font-bold text-blue-900 dark:text-blue-100">{weather.windSpeed}</div>
                </div>
                {weather.sunrise && (
                  <div className="flex flex-col items-center bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-1.5 sm:p-2 border border-yellow-200 dark:border-yellow-800/30">
                    <Sunrise className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-yellow-600 dark:text-yellow-400 mb-0.5" />
                    <div className="text-[8px] sm:text-[9px] font-semibold text-yellow-700 dark:text-yellow-300 uppercase mb-0.5">Rise</div>
                    <div className="text-[9px] sm:text-[10px] font-bold text-yellow-900 dark:text-yellow-100">
                      {weather.sunrise.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })}
                    </div>
                  </div>
                )}
                {weather.sunset && (
                  <div className="flex flex-col items-center bg-pink-50 dark:bg-pink-900/20 rounded-lg p-1.5 sm:p-2 border border-pink-200 dark:border-pink-800/30">
                    <Sunset className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-pink-600 dark:text-pink-400 mb-0.5" />
                    <div className="text-[8px] sm:text-[9px] font-semibold text-pink-700 dark:text-pink-300 uppercase mb-0.5">Set</div>
                    <div className="text-[9px] sm:text-[10px] font-bold text-pink-900 dark:text-pink-100">
